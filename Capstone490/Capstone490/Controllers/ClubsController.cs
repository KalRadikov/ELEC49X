...
namespace Capstone490.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClubID,Name,Category1,Category2,Category3,O_Max,O_Min,C_Max,C_Min,E_Max,E_Min,A_Max,A_Min,N_Max,N_Min")] Club club)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClubID,Name,Category1,Category2,Category3,O_Max,O_Min,C_Max,C_Min,E_Max,E_Min,A_Max,A_Min,N_Max,N_Min")] Club club)
        {
            if (ModelState.IsValid)
            {
